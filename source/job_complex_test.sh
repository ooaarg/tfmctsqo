...
#   cd source && bash ./job_complex_test.sh
#
...
QUERIES_DIR=$(pwd)/resource/job_complex
PLANS_DIR=$(pwd)/../plans_job_complex     # written to repo root (sibling of source/)
TIMING_CSV=$(pwd)/../original_time_job_complex.csv
...
# forced usage of a bunch of parallel workers (JOB-Complex workload).
#
